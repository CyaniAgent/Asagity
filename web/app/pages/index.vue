...
<template>
  <div class="max-w-[1150px] mx-auto w-full flex items-start gap-6 animate-[fade-in_0.4s_ease-out]">
      ...
      <div
        ...
        <div
          ...
          <h2 class="text-[18px] font-black text-gray-900 dark:text-white flex items-center gap-2 tracking-wide">
            <UIcon name="i-material-symbols-public" class="w-5 h-5 text-cyan-500" /> 动态
          </h2>
          <UButton icon="i-material-symbols-tune" color="neutral" variant="ghost"
        ...
        <div class="flex flex-col divide-y divide-white/40 dark:divide-gray-800/50">
          <AppPostItem v-for="post in mockPosts" :key="post.id" :post="post"
    ...
    <aside v-if="!splitViewStore.isOpen"
      ...
      <div
        ...
        <div class="flex flex-col gap-3">
          <div v-for="(topic, idx) in trendingTopics" :key="idx"
      ...
      <div
        ...
        <div class="flex flex-col gap-4">
          <div v-for="(user, idx) in recommendedUsers" :key="idx" class="flex items-center gap-3 group">
            ...
            <UButton icon="i-material-symbols-add" size="xs" color="primary" variant="soft"
