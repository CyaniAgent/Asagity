...
<template>
  <div class="relative w-screen h-screen overflow-hidden flex items-center justify-center bg-gray-900 text-white font-sans">
    ...
    <div class="absolute inset-0 z-0">
      ...
      <div class="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-cyan-500/10 rounded-full blur-[100px]"></div>
      <div class="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-fuchsia-500/10 rounded-full blur-[80px]"></div>
    ...
    <div class="relative z-10 w-full max-w-md bg-black/40 backdrop-blur-3xl border border-white/10 rounded-[32px] p-10 shadow-[0_30px_60px_rgba(0,0,0,0.6)] animate-[fade-in-up_0.6s_ease-out]">
      <!-- Decor Ribbon -->
      <div class="absolute top-0 left-10 w-24 h-1 bg-cyan-500 shadow-[0_0_15px_#39C5BB] rounded-b-md"></div>

      <div class="flex flex-col items-center mb-8">
        <AppLogo class="w-14 h-14 drop-shadow-[0_0_20px_rgba(57,197,187,0.6)] mb-4" />
        <h1 class="text-3xl font-black tracking-wider text-white">身份认证层</h1>
      ...
      <form @submit.prevent="handleLogin" class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-2">
          <div class="flex justify-between items-center ml-2">
            ...
            <a href="#" class="text-[10px] font-bold text-cyan-500 hover:text-cyan-400 hover:underline">忘记密钥？</a>
          </div>
          <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              <UIcon name="i-material-symbols-lock" class="w-5 h-5 text-gray-500" />
            </div>
      ...
      <div class="mt-8 text-center text-xs text-gray-400 font-medium border-t border-white/10 pt-6">
        尚未分配系统凭证？ 
        <NuxtLink to="/register" class="text-cyan-400 font-bold hover:text-cyan-300 underline underline-offset-4 decoration-cyan-500/30">
          初始化新账号 \>
        </NuxtLink>
      </div>
